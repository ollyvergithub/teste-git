...
<div class="container"> 
	...
	<div class="container">
        ...
        <div class="row">
            <div class="col-12 col-sm-6 col-lg-8 border border-primary">.col-12 .col-sm-6 .col-lg-8</div>
            <div class="col-6 col-lg-4 border border-primary">.col-6 .col-lg-4</div>
        </div>

        <div class="row">
            <div class="col-6 col-sm-4 border border-primary">.col-6 .col-sm-4</div>
            <div class="col-6 col-sm-4 border border-primary">.col-6 .col-sm-4</div>
            <div class="col-6 col-sm-4 border border-primary">.col-6 .col-sm-4</div>
        </div>
        ...
        <div class="p-3 mb-2 bg-primary text-white">.bg-primary</div>
            ...
            <div class="row">
                <div class="col-12 col-md-8 bg-primary text-white">.col-12 .col-md-8</div>
                <div class="col-6 col-md-4 bg-success text-white">.col-6 .col-md-4</div>
            </div>
